...
CREATE TABLE IF NOT EXISTS Customer(CustomerID INTEGER NOT NULL UNIQUE
...
CREATE TABLE IF NOT EXISTS Spaceship(SpaceshipID INTEGER NOT NULL UNIQUE
...
CREATE TABLE IF NOT EXISTS Orders(OrderID INTEGER NOT NULL UNIQUE
, InvoiceID INTEGER
, CustomerID INTEGER
, SpaceshipID INTEGER
, OrderDateTime DATE
...
CREATE TABLE IF NOT EXISTS OrderParts(OrderID INTEGER
, PartID INTEGER
...
CREATE TABLE IF NOT EXISTS Part(PartID INTEGER NOT NULL UNIQUE
 , SpaceshipID INTEGER
...
CREATE TABLE IF NOT EXISTS Payment(PaymentID INTEGER
...
CREATE TABLE IF NOT EXISTS Employee(EmployeeID INTEGER NOT NULL UNIQUE
...
CREATE TABLE IF NOT EXISTS MaintenanceRequest(MaintenanceRequestID INTEGER NOT NULL UNIQUE
, SpaceshipID INTEGER
, PartID INTEGER
, RequestedBy INTEGER
, RequestDate DATE
...
CREATE TABLE IF NOT EXISTS FinanceRequest(FinanceRequestID INTEGER NOT NULL UNIQUE
, SpaceshipID INTEGER
, RequestedBy INTEGER
, ReviewedBy INTEGER
, RequestDate DATE
...
CREATE TABLE IF NOT EXISTS Invoice(InvoiceID INTEGER NOT NULL UNIQUE, InvoiceDateTime DATE, InvoiceAmount DECIMAL
, TaxAmount DECIMAL
, Currency VARCHAR(35)
, VendorID INTEGER
, CustomerID INTEGER
...
CREATE TABLE IF NOT EXISTS Vendor(VendorID INTEGER NOT NULL UNIQUE
